  ...
  describe "PUT /questions/:id" do
    ...
    context "With valid authentication headers" do
      ...
      context "when question exists" do
        ...
        context "user is the form owner" do
          before do
            @form = create(:form, user: @user)
          ...
          it "question is updated with correct data" do
            @question.reload
            @question_attributes.each do |field|
  ...
  describe "DELETE /questions/:id" do
    ...
    context "With valid authentication headers" do
      ...
      context "When question exists" do
        ...
        context "And user is the owner" do
          before do
            @form = create(:form, user: @user)
            @question = create(:question, form: @form)
            delete "/api/v1/questions/#{@question.id}", params: {}, 
              headers: header_with_authentication(@user)
          end
      ...
      context "When question doesn't exist" do
        it "returns Not Found" do
          delete "/api/v1/questions/0", params: {}, 
            headers: header_with_authentication(@user)
          expect_status(404)
        end
      end
